...
const themes = [
  {
    ...
    emoji: "📚",
    color: "#4f8ef7",
    desc: "Récit, personnages, narration, point de vue",
    dispo: true,
  },
  {
    id: "la-bd-manga",
    label: "La BD et le manga",
    emoji: "🎨",
    color: "#2ec4b6",
    desc: "Codes de la BD, bulles, case, planche, manga",
    dispo: true,
  },
  {
    ...
    emoji: "💬",
    color: "#ffd166",
    desc: "Rapporter les paroles, concordance des temps",
    dispo: true,
  },
  {
    id: "le-conditionnel",
    ...
    emoji: "⚡",
    color: "#ff6b6b",
    desc: "Conditionnel présent et passé, hypothèses",
    dispo: true,
  },
];
...
export default function Francais4emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/4eme/francais/bilan");
  };
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Français — 4ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/4eme/francais/${t.id}`)
              }
              style={
                {
