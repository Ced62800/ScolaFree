...
const themes = [
  {
    id: "les-figures-de-style",
    label: "Les figures de style",
    emoji: "✨",
    color: "#4f8ef7",
    desc: "Métaphore, comparaison, hyperbole, personnification",
    dispo: true,
  },
  {
    id: "la-phrase-complexe",
    label: "La phrase complexe",
    emoji: "🔗",
    color: "#2ec4b6",
    desc: "Subordination, coordination, juxtaposition",
    dispo: true,
  },
  {
    id: "les-connecteurs",
    ...
    emoji: "➡️",
    color: "#ffd166",
    desc: "Cause, conséquence, opposition, concession",
    dispo: true,
  },
  {
    id: "le-lexique",
    ...
    emoji: "📝",
    color: "#ff6b6b",
    desc: "Synonymes, antonymes, familles de mots, étymologie",
    dispo: true,
  },
];
...
export default function Francais4emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/4eme/francais/bilan-2");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Français 4ème — Partie 2
            {statutBilan === "valide"
              ? " ✅"
              : statutBilan === "en-cours"
                ? " 🟡"
