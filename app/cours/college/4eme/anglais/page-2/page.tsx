...
const themes = [
  {
    ...
    emoji: "🔮",
    color: "#4f8ef7",
    desc: "If clauses type 1, 2 et 3, conditionals",
    dispo: true,
  },
  {
    ...
    emoji: "💬",
    color: "#2ec4b6",
    desc: "Reported speech, changements de temps et pronoms",
    dispo: true,
  },
  {
    id: "droits-citoyennete",
    label: "Droits et citoyennete",
    emoji: "⚖️",
    color: "#ffd166",
    desc: "Vocabulaire des droits, societe, citoyennete",
    dispo: true,
  },
  {
    id: "monde-anglophone",
    label: "Le monde anglophone",
    emoji: "🌍",
    color: "#ff6b6b",
    desc: "Pays anglophones, cultures, institutions",
    dispo: true,
  },
];
...
export default function Anglais4emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/4eme/anglais/bilan-2");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            Bilan Final Anglais 4eme — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
