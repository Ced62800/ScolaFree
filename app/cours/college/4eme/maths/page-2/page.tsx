...
const themes = [
  {
    id: "geometrie-2",
    label: "Géométrie & Thalès",
    emoji: "📐",
    color: "#4f8ef7",
    desc: "Théorème de Thalès, agrandissements, réductions",
    dispo: true,
  },
  {
    id: "trigonometrie",
    label: "La trigonométrie",
    emoji: "📏",
    color: "#2ec4b6",
    desc: "Sinus, cosinus, tangente dans le triangle rectangle",
    dispo: true,
  },
  {
    id: "statistiques-2",
    ...
    emoji: "📈",
    color: "#ffd166",
    desc: "Médiane, quartiles, diagrammes en boîte",
    dispo: true,
  },
  {
    id: "probabilites-2",
    label: "Probabilités avancées",
    emoji: "🎲",
    color: "#ff6b6b",
    desc: "Probabilités conditionnelles, tableaux, arbres",
    dispo: true,
  },
];
...
export default function Maths4emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/4eme/maths/bilan-2");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Maths 4ème — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
