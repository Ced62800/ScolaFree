...
const themes = [
  {
    id: "nombres-relatifs-2",
    label: "Les nombres relatifs (×÷)",
    emoji: "➕",
    color: "#4f8ef7",
    desc: "Multiplication, division, priorités opératoires",
    dispo: true,
  },
  {
    id: "fractions-2",
    label: "Les fractions avancées",
    emoji: "½",
    color: "#2ec4b6",
    desc: "Opérations complexes, fractions et décimaux",
    dispo: true,
  },
  {
    id: "equations",
    ...
    emoji: "🔤",
    color: "#ffd166",
    desc: "Équations du 1er degré, résolution, vérification",
    dispo: true,
  },
  {
    id: "proportionnalite-2",
    label: "La proportionnalité (2)",
    emoji: "📊",
    color: "#ff6b6b",
    desc: "Pourcentages d'évolution, coefficient multiplicateur",
    dispo: true,
  },
];
...
export default function Maths4emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/4eme/maths/bilan");
  };
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Mathématiques — 4ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/4eme/maths/${t.id}`)
              }
              style={
                {
