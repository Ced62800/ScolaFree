...
const themes = [
  {
    ...
    label: "Imparfait & passé simple",
    emoji: "⏳",
    color: "#4f8ef7",
    desc: "Conjugaison et emploi de l'imparfait et du passé simple",
    dispo: true,
  },
  {
    id: "le-complement",
    ...
    emoji: "🔗",
    color: "#2ec4b6",
    desc: "COD, COI, CC de lieu, temps, manière",
    dispo: true,
  },
  {
    id: "les-homophones",
    label: "Les homophones",
    emoji: "✏️",
    color: "#ffd166",
    desc: "a/à, on/ont, son/sont, ce/se, ou/où, mais/mes...",
    dispo: true,
  },
  {
    id: "le-vocabulaire",
    ...
    emoji: "📚",
    color: "#ff6b6b",
    desc: "Dérivation, composition, champ lexical, registres",
    dispo: true,
  },
];
...
export default function Francais5emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/francais/bilan-2");
  };
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Français — 5ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/5eme/francais/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Français 5ème — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
