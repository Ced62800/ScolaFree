...
const themes = [
  {
    ...
    emoji: "📖",
    color: "#4f8ef7",
    desc: "Narration, types de narrateur, schéma narratif",
    dispo: true,
  },
  {
    id: "la-poesie",
    ...
    emoji: "🎭",
    color: "#2ec4b6",
    desc: "Figures de style, versification, poèmes du Moyen-Âge",
    dispo: true,
  },
  {
    id: "le-groupe-nominal",
    label: "Le groupe nominal",
    emoji: "📝",
    color: "#ffd166",
    desc: "Expansions du GN, apposition, épithète, complément",
    dispo: true,
  },
  {
    id: "le-verbe",
    ...
    emoji: "⏰",
    color: "#ff6b6b",
    desc: "Nature, fonction, groupes et conjugaison",
    dispo: true,
  },
];
...
export default function Francais5emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/francais/bilan");
  };
