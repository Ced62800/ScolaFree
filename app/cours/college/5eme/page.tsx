...
const matieres = [
  ...
  },
  {
    ...
    emoji: "🔢",
    color: "#2ec4b6",
    desc: "Nombres relatifs, fractions, géométrie et probabilités",
    dispo: true,
  },
  {
    id: "anglais",
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">5ème</h1>
      ...
      >
        {matieres.map((m) => (
          <div
            ...
            onClick={() =>
              m.dispo && router.push(`/cours/college/5eme/${m.id}`)
            }
            style={
              {
                "--card-color": m.color,
        ...
        <div
          className="theme-card"
          onClick={() => router.push("/atelier-ia/5eme")}
          style={
            {
              "--card-color": "#a855f7",
              position: "relative",
        ...
        >
          ...
          <div className="theme-desc">
            Découvre l&apos;IA et génère des images impossibles !
          </div>
