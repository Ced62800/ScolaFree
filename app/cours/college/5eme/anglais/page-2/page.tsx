...
const themes = [
  {
    id: "futur-will",
    label: "Le futur avec will",
    emoji: "🔮",
    color: "#4f8ef7",
    desc: "Prédictions, décisions spontanées, promesses",
    dispo: true,
  },
  {
    id: "comparatifs",
    ...
    emoji: "📊",
    color: "#2ec4b6",
    desc: "More/less than, as...as, the most/least",
    dispo: true,
  },
  {
    id: "sante-sport",
    ...
    emoji: "🏃",
    color: "#ffd166",
    desc: "Corps humain, maladies, sports, mode de vie sain",
    dispo: true,
  },
  {
    id: "vie-quotidienne",
    label: "Vie quotidienne & culture",
    emoji: "🌎",
    color: "#ff6b6b",
    desc: "Culture anglophone, UK vs USA, traditions",
    dispo: true,
  },
];
...
export default function Anglais5emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/anglais/bilan-2");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Anglais 5ème — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
