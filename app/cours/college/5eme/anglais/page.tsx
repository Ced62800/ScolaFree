...
const themes = [
  {
    id: "passe-compose",
    label: "Le passé simple (Past Simple)",
    emoji: "⏮️",
    color: "#4f8ef7",
    desc: "Actions passées, biographies, récits historiques",
    dispo: true,
  },
  {
    ...
    emoji: "👤",
    color: "#2ec4b6",
    desc: "Apparence, personnalité, caractère",
    dispo: true,
  },
  {
    id: "environnement",
    ...
    emoji: "🌍",
    color: "#ffd166",
    desc: "Nature, problèmes environnementaux, solutions",
    dispo: true,
  },
  {
    id: "medias-technologie",
    label: "Médias & technologie",
    emoji: "📱",
    color: "#ff6b6b",
    desc: "Internet, réseaux sociaux, nouvelles technologies",
    dispo: true,
  },
];
...
export default function Anglais5emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/anglais/bilan");
  };
    ...
    <div className="cours-page">
      <div className="cours-header">
        <button
          ...
          onClick={() => router.push("/cours/college/5eme")}
        >
          ← Retour
        </button>
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Anglais — 5ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/5eme/anglais/${t.id}`)
              }
              style={
                {
