...
const themes = [
  {
    ...
    emoji: "📐",
    color: "#4f8ef7",
    desc: "Triangles, quadrilatères, cercles, symétries",
    dispo: true,
  },
  {
    id: "triangles-pythagore",
    label: "Triangles & Pythagore",
    emoji: "📏",
    color: "#2ec4b6",
    desc: "Triangle rectangle et théorème de Pythagore",
    dispo: true,
  },
  {
    id: "statistiques",
    ...
    emoji: "📈",
    color: "#ffd166",
    desc: "Moyenne, médiane, tableaux, diagrammes",
    dispo: true,
  },
  {
    id: "probabilites",
    ...
    emoji: "🎲",
    color: "#ff6b6b",
    desc: "Expériences aléatoires, probabilités, fréquences",
    dispo: true,
  },
];
...
export default function Maths5emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/maths/bilan-2");
  };
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Mathématiques — 5ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/5eme/maths/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Maths 5ème — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
