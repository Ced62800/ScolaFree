...
const themes = [
  {
    ...
    emoji: "➕",
    color: "#4f8ef7",
    desc: "Positifs, négatifs, addition et soustraction",
    dispo: true,
  },
  {
    id: "fractions",
    ...
    emoji: "½",
    color: "#2ec4b6",
    desc: "Simplification, addition, multiplication, division",
    dispo: true,
  },
  {
    id: "calcul-litteral",
    label: "Le calcul littéral",
    emoji: "🔤",
    color: "#ffd166",
    desc: "Expressions avec des lettres, développer, factoriser",
    dispo: true,
  },
  {
    id: "proportionnalite",
    ...
    emoji: "📊",
    color: "#ff6b6b",
    desc: "Tableaux, pourcentages, échelles",
    dispo: true,
  },
];
...
export default function Maths5emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/5eme/maths/bilan");
  };
