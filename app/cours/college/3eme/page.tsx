...
const matieres = [
  {
    ...
    emoji: "📖",
    color: "#4f8ef7",
    desc: "Roman policier, poésie, subjonctif et rhétorique",
    dispo: true,
  },
  {
    id: "maths",
    ...
    emoji: "🔢",
    color: "#2ec4b6",
    desc: "Pythagore, racines carrées, trigonométrie et probabilités",
    dispo: true,
  },
  {
    id: "anglais",
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">3ème</h1>
      ...
      >
        {matieres.map((m) => (
          <div
            ...
            onClick={() =>
              m.dispo && router.push(`/cours/college/3eme/${m.id}`)
            }
            style={
              {
                "--card-color": m.color,
