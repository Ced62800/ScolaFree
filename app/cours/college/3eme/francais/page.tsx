...
const themes = [
  {
    id: "le-roman-policier",
    label: "Le roman policier",
    emoji: "🔍",
    color: "#4f8ef7",
    desc: "Enquête, indices, suspects, structure du roman policier",
    dispo: true,
  },
  {
    id: "la-poesie-moderne",
    label: "La poésie moderne",
    emoji: "✍️",
    color: "#2ec4b6",
    desc: "Vers libres, figures de style, poètes du XXe siècle",
    dispo: true,
  },
  {
    id: "subjonctif",
    ...
    emoji: "⚡",
    color: "#ffd166",
    desc: "Subjonctif présent et passé, emplois et conjugaison",
    dispo: true,
  },
  {
    id: "les-figures-de-rhetorique",
    label: "Les figures de rhétorique",
    emoji: "🎭",
    color: "#ff6b6b",
    desc: "Métaphore, anaphore, antithèse, ironie et argumentation",
    dispo: true,
  },
];
...
export default function Francais3emePage() {
    ...
    const init = async () => {
      ...
      if (user) {
        ...
        if (data) {
          ...
          const meilleurBilan = data.find((s) => s.theme === "bilan") || null;
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/3eme/francais/bilan");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Français 3ème
            {!chargement && statutBilan === "valide"
              ? " ✅"
              : statutBilan === "en-cours"
                ? " 🟡"
                : ""}
