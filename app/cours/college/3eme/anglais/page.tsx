...
const themes = [
  {
    id: "past-perfect",
    label: "Le past perfect",
    emoji: "⏰",
    color: "#4f8ef7",
    desc: "Had + past participle, sequence of events, narratives",
    dispo: true,
  },
  {
    id: "discours-indirect-2",
    label: "Le discours indirect",
    emoji: "💬",
    color: "#2ec4b6",
    desc: "Reported speech, tense shifts, reporting verbs",
    dispo: true,
  },
  {
    id: "environnement-global",
    label: "Environment & Global issues",
    emoji: "🌍",
    color: "#ffd166",
    desc: "Climate change, pollution, sustainability vocabulary",
    dispo: true,
  },
  {
    id: "medias-societe",
    ...
    emoji: "📱",
    color: "#ff6b6b",
    desc: "Social media, news, influence, digital world vocabulary",
    dispo: true,
  },
];
...
export default function Anglais3emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/3eme/anglais/bilan");
  };
    ...
    <div className="cours-page">
      ...
      {!chargement && (
        ...
        >
          ...
          >
            {estConnecte
              ? "Test all your knowledge from Part 1!"
