...
const themes = [
  {
    ...
    emoji: "🔮",
    color: "#4f8ef7",
    desc: "Must, should, could, might, would — uses and nuances",
    dispo: true,
  },
  {
    id: "relative-clauses",
    ...
    emoji: "🔗",
    color: "#2ec4b6",
    desc: "Who, which, that, where, whose — defining and non-defining",
    dispo: true,
  },
  {
    id: "culture-britannique",
    label: "British & American culture",
    emoji: "🏛️",
    color: "#ffd166",
    desc: "Institutions, traditions, landmarks, history vocabulary",
    dispo: true,
  },
  {
    id: "revision-brevet-anglais",
    label: "Brevet English revision",
    emoji: "🎓",
    color: "#ff6b6b",
    desc: "Comprehension, grammar, writing — exam preparation",
    dispo: true,
  },
];
...
export default function Anglais3emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/3eme/anglais/bilan-2");
  };
    ...
    <div className="cours-page">
      <div className="cours-header">
        ...
        <div className="cours-breadcrumb">
          ...
          <span className="breadcrumb-sep">›</span>
          <span className="breadcrumb-active">Part 2</span>
        </div>
      </div>
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Anglais — 3ème</h1>
        <p className="cours-hero-desc">
          {estConnecte
            ? "Part 2 — Choose a topic!"
            : "Discovery mode — 5 questions per topic"}
        </p>
      </div>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/3eme/anglais/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Final Test — English 3ème — Part 2
          </button>
          <p
            style={{
              color: "#aaa",
          ...
          >
            {estConnecte
              ? "Test all your knowledge from Part 2!"
              : "🔒 Sign up to access the test"}
          </p>
        </div>
      )}
