...
const themes = [
  {
    id: "theoreme-pythagore-2",
    label: "Théorème de Pythagore",
    emoji: "📐",
    color: "#4f8ef7",
    desc: "Calcul de longueurs, réciproque, applications",
    dispo: true,
  },
  {
    id: "racines-carrees",
    label: "Les racines carrées",
    emoji: "√",
    color: "#2ec4b6",
    desc: "Définition, simplification, calculs avec racines",
    dispo: true,
  },
  {
    id: "statistiques-3",
    ...
    emoji: "📈",
    color: "#ffd166",
    desc: "Moyenne, médiane, étendue, interprétation de données",
    dispo: true,
  },
  {
    ...
    emoji: "🔤",
    color: "#ff6b6b",
    desc: "Résolution par substitution et combinaison",
    dispo: true,
  },
];
...
export default function Maths3emePage() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/3eme/maths/bilan");
  };
