...
const themes = [
  {
    ...
    emoji: "📐",
    color: "#4f8ef7",
    desc: "Solides, sections, patrons, volumes et aires",
    dispo: true,
  },
  {
    id: "trigonometrie-2",
    ...
    emoji: "📏",
    color: "#2ec4b6",
    desc: "Sinus, cosinus, tangente, angles et triangles",
    dispo: true,
  },
  {
    id: "probabilites-3",
    ...
    emoji: "🎲",
    color: "#ffd166",
    desc: "Probabilités conditionnelles, arbres, tableaux",
    dispo: true,
  },
  {
    id: "revision-brevet-maths",
    label: "Révision Brevet Maths",
    emoji: "🎓",
    color: "#ff6b6b",
    desc: "Calcul, géométrie, fonctions, statistiques",
    dispo: true,
  },
];
...
export default function Maths3emePageDeux() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/college/3eme/maths/bilan-2");
  };
  ...
  return (
    <div className="cours-page">
      ...
      <div className="cours-hero">
        ...
        <h1 className="cours-hero-title">Mathématiques — 3ème</h1>
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/college/3eme/maths/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        ...
        >
          ...
          >
            🎯 Bilan Final Maths 3ème — Partie 2
          </button>
          <p
            style={{
              color: "#aaa",
