...
export default function MathsCE1Page2() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/primaire/ce1/maths/bilan-2");
  };
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/primaire/ce1/maths/${t.lien}`)
              }
              style={
                {
