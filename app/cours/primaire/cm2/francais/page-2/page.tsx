...
const themes = [
  {
    ...
    emoji: "📝",
    color: "#4f8ef7",
    desc: "Les propositions subordonnées",
    dispo: true,
  },
  {
    id: "conjugaison-2",
  ...
  },
  {
    ...
    emoji: "📚",
    color: "#ff6b6b",
    desc: "Étymologie et sens des mots",
    dispo: true,
  },
];
...
export default function FrancaisCM2Page2() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/primaire/cm2/francais/bilan-2");
  };
    ...
    <div className="cours-page">
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/primaire/cm2/francais/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        <div style={{ marginTop: "40px", textAlign: "center" }}>
          ...
          >
            🎯 Bilan CM2 Français Partie 2 — 20 questions
          </button>
