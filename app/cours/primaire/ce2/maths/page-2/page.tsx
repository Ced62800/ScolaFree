...
const themes = [
  ...
  },
  {
    ...
    emoji: "➕",
    color: "#ffd166",
    desc: "Opérations posées et calcul",
    dispo: true,
  },
  {
    id: "problemes",
...
export default function MathsCE2Page2() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/primaire/ce2/maths/bilan-2");
  };
    ...
    <div className="cours-page">
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/primaire/ce2/maths/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        <div style={{ marginTop: "40px", textAlign: "center" }}>
          ...
          >
            🎯 Bilan CE2 Maths Partie 2 — 20 questions
          </button>
