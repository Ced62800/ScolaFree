...
const lecon = {
  ...
  intro:
    "L'addition permet de regrouper des quantités. La soustraction permet d'en enlever. Ce sont les deux premières opérations qu'on apprend !",
  points: [
    {
      titre: "L'addition",
      texte:
        "Additionner c'est mettre ensemble. Le signe + signifie 'plus'. Le résultat s'appelle la somme.",
      exemple: "3 + 4 = 7 · 12 + 5 = 17 · 20 + 30 = 50",
    },
    {
      titre: "La soustraction",
      texte:
        "Soustraire c'est enlever. Le signe - signifie 'moins'. Le résultat s'appelle la différence.",
      exemple: "8 - 3 = 5 · 15 - 6 = 9 · 30 - 10 = 20",
    },
    {
      titre: "Les problèmes",
      texte:
        "Dans un problème, il faut bien lire pour savoir si on additionne ou on soustrait. Les mots 'en tout', 'au total' → addition. Les mots 'il reste', 'de moins' → soustraction.",
      exemple: "Paul a 5 billes, il en gagne 3. Il en a 5 + 3 = 8 en tout.",
    },
  ],
};
...
const questions = [
  ...
  },
  {
    id: 8,
    question:
      "Tom a 6 images. Son ami lui en donne 7. Combien en a-t-il en tout ?",
    options: ["12", "14", "13", "11"],
    reponse: "13",
    explication: "6 + 7 = 13 images.",
    niveau: "moyen",
  },
  {
    id: 9,
    question: "Combien font 30 - 14 ?",
    options: ["14", "16", "17", "15"],
    reponse: "16",
    explication: "30 - 14 = 16",
    niveau: "difficile",
  },
  {
    id: 10,
    question:
      "Il y a 25 élèves dans une classe. 8 sont absents. Combien sont présents ?",
    options: ["16", "18", "17", "15"],
    reponse: "17",
    explication: "25 - 8 = 17 élèves présents.",
    niveau: "difficile",
  },
];
...
export default function AdditionCP() {
    ...
    <div className="cours-page">
      ...
      {etape === "lecon" && (
        <div className="lecon-wrapper">
          <div className="lecon-badge">➕ Addition et Soustraction · CP</div>
      ...
      {etape === "fini" && (
        <div className="resultat-wrapper">
          ...
          <p className="resultat-desc">
            {score >= 9
              ? "Tu maîtrises parfaitement l'addition et la soustraction !"
              : score >= 7
