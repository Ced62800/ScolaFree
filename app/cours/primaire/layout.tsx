...
export default function ThemeLayout({
  ...
  // Bloquer l'accès aux bilans pour les non connectés
    ...
    return (
      <div className="cours-page">
        ...
        <div style={{ textAlign: "center", padding: "60px 20px" }}>
          ...
          >
            Les bilans permettent de sauvegarder ta progression et de débloquer
            les classes suivantes. Inscris-toi gratuitement pour y accéder !
          </p>
          <div
            style={{
              display: "flex",
