...
const themes = [
  {
    ...
    emoji: "🍕",
    color: "#4f8ef7",
    desc: "Fractions équivalentes et décimales",
    dispo: true,
  },
  {
    id: "proportionnalite",
  ...
  {
    id: "addition-decimaux",
    label: "Opérations décimales",
    emoji: "➕",
    color: "#ffd166",
    desc: "Addition et soustraction de décimaux",
    dispo: true,
  },
  {
    id: "problemes",
    ...
    emoji: "🧩",
    color: "#ff6b6b",
    desc: "Résoudre des problèmes à étapes",
    dispo: true,
  },
];
...
export default function MathsCM1Page2() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/primaire/cm1/maths/bilan-2");
  };
    ...
    <div className="cours-page">
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/primaire/cm1/maths/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        <div style={{ marginTop: "40px", textAlign: "center" }}>
          ...
          >
            🎯 Bilan CM1 Maths Partie 2 — 20 questions
          </button>
