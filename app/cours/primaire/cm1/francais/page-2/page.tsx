...
export default function FrancaisCM1Page2() {
  ...
  const handleBilan = () => {
    ...
    router.push("/cours/primaire/cm1/francais/bilan-2");
  };
    ...
    <div className="cours-page">
        ...
        {themes.map((t) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                t.dispo && router.push(`/cours/primaire/cm1/francais/${t.id}`)
              }
              style={
                {
      ...
      {!chargement && (
        <div style={{ marginTop: "40px", textAlign: "center" }}>
          ...
          >
            🎯 Bilan CM1 Français Partie 2 — 20 questions
          </button>
