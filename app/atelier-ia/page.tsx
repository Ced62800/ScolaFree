...
const niveaux = [
  ...
  { slug: "6eme", label: "6ème", emoji: "🔍", color: "#4f8ef7", dispo: false },
      ...
      <div className="themes-grid">
        {niveaux.map((n) => (
          <div
            ...
            style={
              {
                "--card-color": n.dispo ? n.color : "#888",
                position: "relative",
                cursor: n.dispo ? "pointer" : "not-allowed",
                opacity: n.dispo ? 1 : 0.5,
                border: "2px solid rgba(255,255,255,0.06)",
              } as React.CSSProperties
            }
            onClick={n.dispo ? undefined : undefined}
          >
            {!n.dispo && (
              <div
                style={{
            ...
            <div className="theme-desc">3 modules pour découvrir l&apos;IA</div>
            {n.dispo ? (
              <Link
