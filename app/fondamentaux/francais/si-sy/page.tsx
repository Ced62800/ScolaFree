...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Il ___ rend tous les jours.",
    reponse: "s'y",
    explication:
      "'S'y' = 'se' + 'y'. Il se rend là-bas tous les jours → s'y rend.",
  },
  {
    id: 2,
    phrase: "___ tu veux, on peut partir maintenant.",
    reponse: "Si",
    explication: "'Si' introduit une condition → Si tu veux.",
  },
  {
    id: 3,
    phrase: "Elle ___ connaît très bien en cuisine.",
    reponse: "s'y",
    explication:
      "'S'y connaître' = être compétent dans quelque chose. Elle s'y connaît → s'y.",
  },
  {
    id: 4,
    phrase: "___ seulement il faisait beau !",
    reponse: "Si",
    explication:
      "'Si seulement' exprime un souhait → Si seulement il faisait beau.",
  },
  {
    id: 5,
    phrase: "Il ___ attendait depuis longtemps.",
    reponse: "s'y",
    explication: "'S'y' = 'se' + 'y'. Il s'attendait à cela → s'y attendait.",
  },
  {
    id: 6,
    phrase: "___ tu travailles, tu réussiras.",
    reponse: "Si",
    explication: "'Si' introduit une condition → Si tu travailles.",
  },
  {
    id: 7,
    phrase: "Elle ___ est habituée maintenant.",
    reponse: "s'y",
    explication:
      "'S'y habituer' = s'habituer à quelque chose. Elle s'y est habituée → s'y.",
  },
  {
    id: 8,
    phrase: "___ c'est vrai, c'est incroyable !",
    reponse: "Si",
    explication: "'Si' introduit une hypothèse → Si c'est vrai.",
  },
  {
    id: 9,
    phrase: "Il ___ prend bien avec les enfants.",
    reponse: "s'y",
    explication:
      "'S'y prendre' = agir d'une certaine façon. Il s'y prend bien → s'y.",
  },
  {
    id: 10,
    phrase: "___ tu es fatigué, repose-toi.",
    reponse: "Si",
    explication: "'Si' introduit une condition → Si tu es fatigué.",
  },
  {
    id: 11,
    phrase: "Elle ___ met beaucoup de cœur.",
    reponse: "s'y",
    explication:
      "'S'y mettre' = commencer à faire quelque chose. Elle s'y met → s'y.",
  },
  {
    id: 12,
    phrase: "___ on part tôt, on arrivera à temps.",
    reponse: "Si",
    explication: "'Si' introduit une condition → Si on part tôt.",
  },
];
...
export default function FicheSiSy() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Si / S'y !"
              : pourcentage >= 50
                ? "Pas mal ! Si = condition, S'y = se + y."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#a78bfa" }}>SI</strong> = pour exprimer une
            condition ou un souhait. Exemple : <em>si</em> tu veux = dans le cas
            où tu veux ✅<br />
            <strong style={{ color: "#4f8ef7" }}>S&apos;Y</strong> =
            &quot;se&quot; + &quot;y&quot;, toujours collé à un verbe. Exemple :
            il <em>s&apos;y</em> rend = il se rend <em>là-bas</em> ✅<br />
            ...
            → c&apos;est <strong style={{ color: "#a78bfa" }}>SI</strong>. Si tu
            peux remplacer par{" "}
            <strong style={{ color: "#4f8ef7" }}>
              &quot;là-bas&quot; ou &quot;à cela&quot;
            </strong>{" "}
            → c&apos;est <strong style={{ color: "#4f8ef7" }}>S&apos;Y</strong>.
          </p>
        </div>
