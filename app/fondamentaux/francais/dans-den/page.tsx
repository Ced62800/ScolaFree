...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Le chat est ___ la boîte.",
    reponse: "dans",
    explication:
      "'Dans' indique un endroit. Le chat est à l'intérieur de la boîte → dans.",
  },
  {
    id: 2,
    phrase: "Il a besoin ___ parler.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Il a besoin d'en parler = il a besoin de parler de cela → d'en.",
  },
  {
    id: 3,
    phrase: "Elle arrive ___ cinq minutes.",
    reponse: "dans",
    explication:
      "'Dans' indique un délai. Elle arrive dans cinq minutes → dans.",
  },
  {
    id: 4,
    phrase: "Il refuse ___ entendre parler.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Il refuse d'en entendre parler = il refuse de parler de cela → d'en.",
  },
  {
    id: 5,
    phrase: "Mets tes affaires ___ ton sac.",
    reponse: "dans",
    explication: "'Dans' indique un endroit. À l'intérieur du sac → dans.",
  },
  {
    id: 6,
    phrase: "Elle a envie ___ savoir plus.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Elle a envie d'en savoir plus = elle veut en savoir davantage → d'en.",
  },
  {
    id: 7,
    phrase: "Il habite ___ cette ville depuis dix ans.",
    reponse: "dans",
    explication:
      "'Dans' indique un endroit. Il habite à l'intérieur de cette ville → dans.",
  },
  {
    id: 8,
    phrase: "Je suis fatigué ___ parler.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Fatigué d'en parler = fatigué de parler de cela → d'en.",
  },
  {
    id: 9,
    phrase: "Elle travaille ___ une grande entreprise.",
    reponse: "dans",
    explication:
      "'Dans' indique un endroit. Elle travaille à l'intérieur d'une entreprise → dans.",
  },
  {
    id: 10,
    phrase: "Il est temps ___ finir.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Il est temps d'en finir = il est temps de terminer cela → d'en.",
  },
  {
    id: 11,
    phrase: "Range ce livre ___ la bibliothèque.",
    reponse: "dans",
    explication:
      "'Dans' indique un endroit. À l'intérieur de la bibliothèque → dans.",
  },
  {
    id: 12,
    phrase: "Elle a décidé ___ rire.",
    reponse: "d'en",
    explication:
      "'D'en' = 'de' + 'en'. Elle a décidé d'en rire = elle a décidé de rire de cela → d'en.",
  },
];
...
const CHOIX = ["dans", "d'en"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FicheDansDen() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Dans / D'en !"
              : pourcentage >= 50
                ? "Pas mal ! Dans = lieu ou délai, d'en = de + en."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#2ec4b6" }}>DANS</strong> = à
            l&apos;intérieur de, ou dans un délai. Exemple : le chat est{" "}
            <em>dans</em> la boîte = à l&apos;intérieur ✅. Il arrive{" "}
            <em>dans</em> 5 minutes = dans un délai ✅<br />
            <strong style={{ color: "#ffd166" }}>D&apos;EN</strong> =
            &quot;de&quot; + &quot;en&quot;, toujours suivi d&apos;un verbe.
            Exemple : il a besoin <em>d&apos;en</em> parler = il a besoin de
            parler <em>de cela</em> ✅<br />
            ...
            → DANS. Si tu peux ajouter{" "}
            <strong style={{ color: "#ffd166" }}>&quot;de cela&quot;</strong>{" "}
            après → D&apos;EN.
          </p>
        </div>
