...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Je préfère le chocolat ___ la vanille.",
    reponse: "plutôt que",
    explication:
      "'Plutôt que' exprime une préférence. Il n'est pas question d'heure → plutôt.",
  },
  {
    id: 2,
    phrase: "Il est arrivé ___ que prévu.",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment dans le temps. On peut remplacer par 'plus tôt dans la journée' → plus tôt.",
  },
  {
    id: 3,
    phrase: "Elle est ___ timide que bavarde.",
    reponse: "plutôt",
    explication:
      "'Plutôt' exprime une caractéristique dominante, une préférence → plutôt.",
  },
  {
    id: 4,
    phrase: "Lève-toi ___ demain matin !",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment dans le temps. L'opposé serait 'plus tard' → plus tôt.",
  },
  {
    id: 5,
    phrase: "Il fait ___ froid aujourd'hui.",
    reponse: "plutôt",
    explication:
      "'Plutôt' = assez, relativement. Il ne s'agit pas d'une heure → plutôt.",
  },
  {
    id: 6,
    phrase: "Le film a commencé ___ que d'habitude.",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment. L'opposé est 'plus tard' → plus tôt.",
  },
  {
    id: 7,
    phrase: "Je prendrais ___ un café qu'un thé.",
    reponse: "plutôt",
    explication: "'Plutôt' exprime une préférence entre deux choses → plutôt.",
  },
  {
    id: 8,
    phrase: "Elle s'est couchée ___ hier soir.",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment dans le temps. L'opposé est 'plus tard' → plus tôt.",
  },
  {
    id: 9,
    phrase: "C'est ___ une bonne idée.",
    reponse: "plutôt",
    explication:
      "'Plutôt' = assez, relativement bonne. Il ne s'agit pas d'une heure → plutôt.",
  },
  {
    id: 10,
    phrase: "Pars ___ pour éviter les embouteillages.",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment dans le temps. L'opposé est 'plus tard' → plus tôt.",
  },
  {
    id: 11,
    phrase: "Il est ___ grand pour son âge.",
    reponse: "plutôt",
    explication:
      "'Plutôt' = assez, relativement. Il ne s'agit pas d'une heure → plutôt.",
  },
  {
    id: 12,
    phrase: "Le soleil s'est couché ___ ce soir.",
    reponse: "plus tôt",
    explication:
      "'Plus tôt' parle d'un moment dans le temps. L'opposé est 'plus tard' → plus tôt.",
  },
...
const CHOIX = ["plutôt", "plus tôt"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FichePlutotPlusTot() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Plutôt / Plus tôt !"
              : pourcentage >= 50
                ? "Pas mal ! Pense à l'astuce 'plus tard'."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Remplace par{" "}
            <strong style={{ color: "#ffd166" }}>&quot;plus tard&quot;</strong>.
            Si ça marche → c&apos;est{" "}
            <strong style={{ color: "#ffd166" }}>PLUS TÔT</strong> (on parle
            d&apos;un moment dans le temps). Exemple : il est arrivé{" "}
            <em>plus tôt</em> → l&apos;opposé serait &quot;plus tard&quot; ✅
            <br />
            Si ça ne marche pas → c&apos;est{" "}
            <strong style={{ color: "#ff6b6b" }}>PLUTÔT</strong> (préférence ou
            &quot;assez&quot;). Exemple : je préfère <em>plutôt</em> le chocolat
            → &quot;plus tard le chocolat&quot; ❌ → c&apos;est PLUTÔT.
          </p>
        </div>
