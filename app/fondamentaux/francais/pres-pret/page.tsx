...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "La boulangerie est ___ de chez moi.",
    reponse: "près",
    explication:
      "'Près' indique une distance courte. On peut remplacer par 'proche' → près.",
  },
  {
    id: 2,
    phrase: "Tu es ___ à partir ?",
    reponse: "prêt",
    explication:
      "'Prêt' = préparé, disponible. On peut remplacer par 'préparé' → prêt.",
  },
  {
    id: 3,
    phrase: "Il habite tout ___ de l'école.",
    reponse: "près",
    explication:
      "'Près' indique une proximité. On peut remplacer par 'proche' → près.",
  },
  {
    id: 4,
    phrase: "Le dîner est ___, on peut passer à table.",
    reponse: "prêt",
    explication:
      "'Prêt' = préparé, disponible. On peut remplacer par 'préparé' → prêt.",
  },
  {
    id: 5,
    phrase: "Elle s'est assise ___ de la fenêtre.",
    reponse: "près",
    explication: "'Près' indique une proximité dans l'espace → près.",
  },
  {
    id: 6,
    phrase: "Je suis ___ à faire des efforts.",
    reponse: "prêt",
    explication: "'Prêt à' = disposé à, préparé à → prêt.",
  },
  {
    id: 7,
    phrase: "Le chat dort ___ du radiateur.",
    reponse: "près",
    explication:
      "'Près' indique une proximité. On peut remplacer par 'proche' → près.",
  },
  {
    id: 8,
    phrase: "Elle n'est pas encore ___ pour l'examen.",
    reponse: "prête",
    explication: "'Prête' s'accorde au féminin. Elle est préparée → prête.",
  },
  {
    id: 9,
    phrase: "La gare est ___ d'ici, à cinq minutes.",
    reponse: "près",
    explication:
      "'Près' indique une distance courte. Remplace par 'proche' → près.",
  },
  {
    id: 10,
    phrase: "Tout est ___, on peut commencer.",
    reponse: "prêt",
    explication: "'Prêt' = préparé, disponible → prêt.",
  },
  {
    id: 11,
    phrase: "Il s'est assis ___ d'elle.",
    reponse: "près",
    explication: "'Près' indique une proximité dans l'espace → près.",
  },
  {
    id: 12,
    phrase: "Les enfants sont ___ à aller au lit.",
    reponse: "prêts",
    explication:
      "'Prêts' s'accorde au masculin pluriel. Ils sont préparés → prêts.",
  },
];
...
const CHOIX = ["près", "prêt"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FichePresPret() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Près / Prêt !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi : proche = près, préparé = prêt."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#a78bfa" }}>PRÈS</strong> = proche, pas
            loin. Remplace par{" "}
            <strong style={{ color: "#a78bfa" }}>&quot;proche&quot;</strong>.
            Exemple : il habite <em>près</em> = il habite <em>proche</em> ✅
            <br />
            <strong style={{ color: "#2ec4b6" }}>PRÊT</strong> = préparé,
            disponible. Remplace par{" "}
            <strong style={{ color: "#2ec4b6" }}>&quot;préparé&quot;</strong>.
            Exemple : je suis <em>prêt</em> = je suis <em>préparé</em> ✅<br />
            <strong style={{ color: "rgba(255,255,255,0.4)" }}>
              Astuce bonus :
            </strong>{" "}
            PRÊT s&apos;accorde ! → <em>prête</em> (féminin), <em>prêts</em>{" "}
            (masculin pluriel), <em>prêtes</em> (féminin pluriel).
          </p>
        </div>
