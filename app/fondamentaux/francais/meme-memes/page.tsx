...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Ils ont les ___ idées que nous.",
    reponse: "mêmes",
    explication:
      "'Mêmes' s'accorde avec 'idées' (pluriel) → les mêmes idées ✅.",
  },
  {
    id: 2,
    phrase: "Elle travaille ___ le dimanche.",
    reponse: "même",
    explication:
      "'Même' = y compris, aussi. Invariable quand il signifie 'y compris' → même le dimanche ✅.",
  },
  {
    id: 3,
    phrase: "Ce sont les ___ personnes qu'hier.",
    reponse: "mêmes",
    explication:
      "'Mêmes' s'accorde avec 'personnes' (pluriel) → les mêmes personnes ✅.",
  },
  {
    id: 4,
    phrase: "Il ne change pas, c'est toujours le ___ .",
    reponse: "même",
    explication: "'Même' = identique, singulier → c'est le même ✅.",
  },
  {
    id: 5,
    phrase: "Ils sont tous pareils, ce sont les ___.",
    reponse: "mêmes",
    explication: "'Mêmes' au pluriel → ce sont les mêmes ✅.",
  },
  {
    id: 6,
    phrase: "Elle est ___ arrivée avant moi.",
    reponse: "même",
    explication:
      "'Même' = y compris, aussi. Invariable → même arrivée avant moi ✅.",
  },
  {
    id: 7,
    phrase: "Nous avons les ___ goûts.",
    reponse: "mêmes",
    explication:
      "'Mêmes' s'accorde avec 'goûts' (pluriel) → les mêmes goûts ✅.",
  },
  {
    id: 8,
    phrase: "C'est la ___ chose que la dernière fois.",
    reponse: "même",
    explication:
      "'Même' s'accorde avec 'chose' (singulier) → la même chose ✅.",
  },
  {
    id: 9,
    phrase: "Ils ont les ___ problèmes que nous.",
    reponse: "mêmes",
    explication:
      "'Mêmes' s'accorde avec 'problèmes' (pluriel) → les mêmes problèmes ✅.",
  },
  {
    id: 10,
    phrase: "Il a réussi, ___ sans aide.",
    reponse: "même",
    explication:
      "'Même' = y compris, quand même. Invariable → même sans aide ✅.",
  },
  {
    id: 11,
    phrase: "Ce sont les ___ erreurs à chaque fois.",
    reponse: "mêmes",
    explication:
      "'Mêmes' s'accorde avec 'erreurs' (pluriel) → les mêmes erreurs ✅.",
  },
  {
    id: 12,
    phrase: "Il est toujours le ___ après toutes ces années.",
    reponse: "même",
    explication: "'Même' = identique, singulier → le même ✅.",
  },
];
...
const CHOIX = ["même", "mêmes"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FicheMeme() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Même / Mêmes !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi : mêmes prend un s devant un nom pluriel."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#ffd166" }}>MÊMES</strong> (avec s) =
            devant un nom pluriel. Remplace par{" "}
            <strong style={{ color: "#ffd166" }}>&quot;identiques&quot;</strong>
            . Si ça marche → MÊMES. Exemple : les <em>mêmes</em> idées → les
            idées <em>identiques</em> ✅<br />
            <strong style={{ color: "#2ec4b6" }}>MÊME</strong> (sans s) = deux
            cas :<br />• Devant un nom singulier : la <em>même</em> chose = la
            chose identique ✅<br />• Signifie &quot;y compris&quot; ou
            &quot;quand même&quot; → toujours invariable. Exemple : il travaille{" "}
            <em>même</em> le dimanche = y compris le dimanche ✅
          </p>
        </div>
