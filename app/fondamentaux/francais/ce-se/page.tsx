...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Il ___ lave les mains avant de manger.",
    reponse: "se",
    explication:
      "'Se' est un pronom réfléchi. Il fait l'action sur lui-même → se lave.",
  },
  {
    id: 2,
    phrase: "___ livre est très intéressant.",
    reponse: "Ce",
    explication:
      "'Ce' est un adjectif démonstratif. On peut remplacer par 'cet' → Ce livre.",
  },
  {
    id: 3,
    phrase: "Elle ___ souvient de ses vacances.",
    reponse: "se",
    explication: "'Se souvenir' est un verbe pronominal → se souvient.",
  },
  {
    id: 4,
    phrase: "___ matin, il fait très froid.",
    reponse: "Ce",
    explication:
      "'Ce' est un adjectif démonstratif devant un nom masculin → Ce matin.",
  },
  {
    id: 5,
    phrase: "Le chat ___ cache sous le lit.",
    reponse: "se",
    explication: "'Se cacher' est un verbe pronominal → se cache.",
  },
  {
    id: 6,
    phrase: "___ que tu dis est très intéressant.",
    reponse: "Ce",
    explication: "'Ce que' = pronom démonstratif neutre → Ce que tu dis.",
  },
  {
    id: 7,
    phrase: "Il ___ lève toujours à sept heures.",
    reponse: "se",
    explication: "'Se lever' est un verbe pronominal → se lève.",
  },
  {
    id: 8,
    phrase: "___ film m'a beaucoup ému.",
    reponse: "Ce",
    explication:
      "'Ce' est un adjectif démonstratif devant un nom masculin → Ce film.",
  },
  {
    id: 9,
    phrase: "Elle ___ demande si elle a bien fait.",
    reponse: "se",
    explication: "'Se demander' est un verbe pronominal → se demande.",
  },
  {
    id: 10,
    phrase: "___ sont eux qui ont gagné.",
    reponse: "Ce",
    explication:
      "'Ce sont' = expression figée avec le pronom démonstratif → Ce sont.",
  },
  {
    id: 11,
    phrase: "Le chien ___ roule dans l'herbe.",
    reponse: "se",
    explication: "'Se rouler' est un verbe pronominal → se roule.",
  },
  {
    id: 12,
    phrase: "___ problème est difficile à résoudre.",
    reponse: "Ce",
    explication:
      "'Ce' est un adjectif démonstratif devant un nom masculin → Ce problème.",
  },
];
...
export default function FicheCeSe() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Ce / Se !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi de l'astuce."
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            <strong style={{ color: "#ffd166" }}>&quot;me&quot;</strong> ou{" "}
            <strong style={{ color: "#ffd166" }}>&quot;te&quot;</strong>. Si ça
            marche → c&apos;est <strong style={{ color: "#ffd166" }}>SE</strong>
            . Exemple : il <em>se</em> lave → il <em>me</em> lave ✓. Si ça ne
            marche pas → c&apos;est{" "}
            <strong style={{ color: "#ff6b6b" }}>CE</strong>. Exemple :{" "}
            <em>ce</em> livre → <em>me</em> livre ✗ → donc CE.
          </p>
        </div>
