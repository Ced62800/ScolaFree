...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Il ___ vue hier au marché.",
    reponse: "l'a",
    explication:
      "'L'a' = 'il l'avait vue' fonctionne → l'a (pronom + verbe avoir).",
  },
  {
    id: 2,
    phrase: "Pose le livre ___, sur la table.",
    reponse: "là",
    explication:
      "'Là' indique un endroit précis. On peut remplacer par 'ici' → là.",
  },
  {
    id: 3,
    phrase: "Tu ___ vu passer dans la rue ?",
    reponse: "l'as",
    explication:
      "'L'as' = 'tu l'avais vu' fonctionne → l'as (pronom + verbe avoir, 2e personne).",
  },
  {
    id: 4,
    phrase: "Prends ___ rouge, pas la bleue.",
    reponse: "la",
    explication:
      "'La' est un article ou pronom féminin. On ne peut pas dire 'l'avait rouge'.",
  },
  {
    id: 5,
    phrase: "Elle est ___, dans sa chambre.",
    reponse: "là",
    explication: "'Là' indique un endroit. On peut remplacer par 'ici' → là.",
  },
  {
    id: 6,
    phrase: "Je ___ trouvé sous le canapé.",
    reponse: "l'ai",
    explication:
      "'L'ai' = 'je l'avais trouvé' fonctionne → l'ai (pronom + verbe avoir, 1re personne).",
  },
  {
    id: 7,
    phrase: "___ maison de mes grands-parents est grande.",
    reponse: "La",
    explication:
      "'La' est un article défini féminin. On ne peut pas dire 'l'avait maison'.",
  },
  {
    id: 8,
    phrase: "C'est ___ que tout a commencé.",
    reponse: "là",
    explication: "'Là' indique un endroit ou un moment précis → là.",
  },
  {
    id: 9,
    phrase: "Il ___ reconnue tout de suite.",
    reponse: "l'a",
    explication:
      "'L'a' = 'il l'avait reconnue' fonctionne → l'a (pronom + verbe avoir).",
  },
  {
    id: 10,
    phrase: "Tu ___ déjà dit plusieurs fois.",
    reponse: "l'as",
    explication:
      "'L'as' = 'tu l'avais dit' fonctionne → l'as (pronom + verbe avoir, 2e personne).",
  },
  {
    id: 11,
    phrase: "Regarde ___ voiture, elle est belle !",
    reponse: "la",
    explication: "'La' est un article défini féminin → la voiture.",
  },
  {
    id: 12,
    phrase: "Reste ___, je reviens dans cinq minutes.",
    reponse: "là",
    explication: "'Là' indique un endroit. On peut remplacer par 'ici' → là.",
  },
];
...
const CHOIX = ["la", "là", "l'a", "l'as"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FicheLaLa() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises La / Là / L'a / L'as !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi des astuces."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#ffd166" }}>LÀ</strong> → remplace par{" "}
            <strong style={{ color: "#ffd166" }}>&quot;ici&quot;</strong>. Si ça
            marche → c&apos;est LÀ. Exemple : reste <em>là</em> → reste{" "}
            <em>ici</em> ✅{"\n"}
            <br />
            <strong style={{ color: "#2ec4b6" }}>L&apos;A / L&apos;AS</strong> →
            remplace par{" "}
            ...
            . Si ça marche → c&apos;est L&apos;A ou L&apos;AS. Exemple : il{" "}
            <em>l&apos;a</em> vu → il <em>l&apos;avait</em> vu ✅<br />
            <strong style={{ color: "#a78bfa" }}>LA</strong> → dans tous les
            autres cas (article ou pronom féminin). Exemple : <em>la</em>{" "}
            maison, prends <em>la</em>.
          </p>
        </div>
