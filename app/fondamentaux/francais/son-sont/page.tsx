...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Le chien remue ___ queue.",
    reponse: "son",
    explication:
      "'Son' est un adjectif possessif. On peut le remplacer par 'mon' ou 'ton' → son.",
  },
  {
    id: 2,
    phrase: "Ils ___ partis très tôt ce matin.",
    reponse: "sont",
    explication: "On peut remplacer par 'étaient' → sont (verbe être).",
  },
  {
    id: 3,
    phrase: "Elle range ___ cartable.",
    reponse: "son",
    explication:
      "'Son cartable' = 'le cartable de elle'. Son est un adjectif possessif.",
  },
  {
    id: 4,
    phrase: "Les fleurs ___ magnifiques ce printemps.",
    reponse: "sont",
    explication: "On peut remplacer par 'étaient' → sont (verbe être).",
  },
  {
    id: 5,
    phrase: "Il a oublié ___ téléphone à la maison.",
    reponse: "son",
    explication:
      "'Son téléphone' = 'le téléphone de lui'. Son est un adjectif possessif.",
  },
  {
    id: 6,
    phrase: "Les enfants ___ fatigués après la randonnée.",
    reponse: "sont",
    explication:
      "'Les enfants étaient fatigués' fonctionne → sont (verbe être).",
  },
  {
    id: 7,
    phrase: "Marie adore ___ chat roux.",
    reponse: "son",
    explication:
      "'Son chat' = 'le chat de Marie'. Son est un adjectif possessif.",
  },
  {
    id: 8,
    phrase: "Les résultats ___ excellents cette année.",
    reponse: "sont",
    explication: "On peut remplacer par 'étaient' → sont (verbe être).",
  },
  {
    id: 9,
    phrase: "Il a perdu ___ chemin dans la forêt.",
    reponse: "son",
    explication:
      "'Son chemin' = 'le chemin de lui'. Son est un adjectif possessif.",
  },
  {
    id: 10,
    phrase: "Mes parents ___ en vacances cette semaine.",
    reponse: "sont",
    explication: "On peut remplacer par 'étaient' → sont (verbe être).",
  },
  {
    id: 11,
    phrase: "Le professeur corrige ___ cours.",
    reponse: "son",
    explication:
      "'Son cours' = 'le cours de lui'. Son est un adjectif possessif.",
  },
  {
    id: 12,
    phrase: "Les portes ___ fermées à clé.",
    reponse: "sont",
    explication: "On peut remplacer par 'étaient' → sont (verbe être).",
  },
];
...
const CHOIX = ["son", "sont"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FicheSonSont() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Son / Sont !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi de l'astuce 'étaient'."
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            <strong style={{ color: "#ffd166" }}>&quot;étaient&quot;</strong>.
            Si ça marche → c&apos;est{" "}
            <strong style={{ color: "#2ec4b6" }}>SONT</strong> (verbe être). Si
            ça ne marche pas → c&apos;est{" "}
            <strong style={{ color: "#a78bfa" }}>SON</strong> (adjectif
            possessif, remplaçable par &quot;mon&quot; ou &quot;ton&quot;).
          </p>
        </div>
