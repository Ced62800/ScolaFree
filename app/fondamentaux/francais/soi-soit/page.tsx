...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Il faut penser à ___.",
    reponse: "soi",
    explication: "'Soi' est un pronom réfléchi = penser à soi-même → soi.",
  },
  {
    id: 2,
    phrase: "Il faut ___ patient pour réussir.",
    reponse: "soit",
    explication:
      "'Soit' = verbe être au subjonctif. Il faut qu'on soit patient → soit.",
  },
  {
    id: 3,
    phrase: "Chacun pour ___.",
    reponse: "soi",
    explication: "'Soi' est un pronom réfléchi = chacun pour lui-même → soi.",
  },
  {
    id: 4,
    phrase: "___ il vient, ___ il ne vient pas.",
    reponse: "Soit",
    explication:
      "'Soit...soit' = ou bien...ou bien. C'est une alternative → Soit.",
  },
  {
    id: 5,
    phrase: "On doit être fier de ___.",
    reponse: "soi",
    explication: "'Soi' est un pronom réfléchi = être fier de soi-même → soi.",
  },
  {
    id: 6,
    phrase: "Il faut ___ courageux dans la vie.",
    reponse: "soit",
    explication:
      "'Soit' = verbe être au subjonctif. Il faut qu'on soit courageux → soit.",
  },
  {
    id: 7,
    phrase: "Cela va de ___ .",
    reponse: "soi",
    explication:
      "'Cela va de soi' est une expression figée = c'est évident → soi.",
  },
  {
    id: 8,
    phrase: "___ tu travailles, ___ tu te reposes.",
    reponse: "Soit",
    explication: "'Soit...soit' = ou bien...ou bien → Soit.",
  },
  {
    id: 9,
    phrase: "Il est bien ___ dans sa peau.",
    reponse: "soi",
    explication:
      "'Soi' est un pronom réfléchi = bien dans sa propre peau → soi.",
  },
  {
    id: 10,
    phrase: "Que ce ___ lui ou elle, peu importe.",
    reponse: "soit",
    explication:
      "'Soit' = verbe être au subjonctif → que ce soit lui ou elle ✅.",
  },
  {
    id: 11,
    phrase: "On ne peut compter que sur ___.",
    reponse: "soi",
    explication: "'Soi' est un pronom réfléchi = compter sur soi-même → soi.",
  },
  {
    id: 12,
    phrase: "Il faut ___ honnête avec soi-même.",
    reponse: "soit",
    explication:
      "'Soit' = verbe être au subjonctif. Il faut qu'on soit honnête → soit.",
  },
];
...
const CHOIX = ["soi", "soit"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FicheSoiSoit() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Soi / Soit !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi : soi = soi-même, soit = verbe être."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Remplace par{" "}
            <strong style={{ color: "#2ec4b6" }}>&quot;soi-même&quot;</strong>.
            Si ça marche → c&apos;est{" "}
            <strong style={{ color: "#2ec4b6" }}>SOI</strong>. Exemple : penser
            à <em>soi</em> → penser à <em>soi-même</em> ✅<br />
            Si ça ne marche pas → c&apos;est{" "}
            <strong style={{ color: "#a78bfa" }}>SOIT</strong>. Il a deux usages
            :<br />• <strong style={{ color: "#a78bfa" }}>SOIT...SOIT</strong> =
            ou bien...ou bien. Exemple : <em>soit</em> il vient, <em>soit</em>{" "}
            il reste ✅<br />•{" "}
            <strong style={{ color: "#a78bfa" }}>SOIT</strong> seul = qu&apos;il
            soit, que ce soit. Exemple : il faut qu&apos;il <em>soit</em>{" "}
            courageux ✅
          </p>
        </div>
