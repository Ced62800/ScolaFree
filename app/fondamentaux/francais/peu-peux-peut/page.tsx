...
const TOUTES_LES_QUESTIONS = [
  {
    id: 1,
    phrase: "Il mange ___ de sucre.",
    reponse: "peu",
    explication:
      "'Peu' est un adverbe de quantité. On ne peut pas le remplacer par 'pouvait' → peu.",
  },
  {
    id: 2,
    phrase: "Je ne ___ pas venir ce soir.",
    reponse: "peux",
    explication:
      "On peut remplacer par 'pouvais' → peux (verbe pouvoir, 1re personne).",
  },
  {
    id: 3,
    phrase: "Elle ___ nager très vite.",
    reponse: "peut",
    explication:
      "On peut remplacer par 'pouvait' → peut (verbe pouvoir, 3e personne).",
  },
  {
    id: 4,
    phrase: "Il reste ___ de temps avant la fin.",
    reponse: "peu",
    explication:
      "'Peu' est un adverbe de quantité. Impossible de remplacer par 'pouvait'.",
  },
  {
    id: 5,
    phrase: "Tu ___ m'aider s'il te plaît ?",
    reponse: "peux",
    explication:
      "On peut remplacer par 'pouvais' → peux (verbe pouvoir, 2e personne).",
  },
  {
    id: 6,
    phrase: "Il ___ faire beaucoup mieux.",
    reponse: "peut",
    explication:
      "On peut remplacer par 'pouvait' → peut (verbe pouvoir, 3e personne).",
  },
  {
    id: 7,
    phrase: "Elle parle ___ mais dit des choses importantes.",
    reponse: "peu",
    explication: "'Peu' est un adverbe de quantité → peu.",
  },
  {
    id: 8,
    phrase: "Je ___ comprendre ta réaction.",
    reponse: "peux",
    explication:
      "On peut remplacer par 'pouvais' → peux (verbe pouvoir, 1re personne).",
  },
  {
    id: 9,
    phrase: "Tout le monde ___ apprendre à lire.",
    reponse: "peut",
    explication:
      "On peut remplacer par 'pouvait' → peut (verbe pouvoir, 3e personne).",
  },
  {
    id: 10,
    phrase: "Il y a ___ de monde aujourd'hui.",
    reponse: "peu",
    explication:
      "'Peu' est un adverbe de quantité. Impossible de remplacer par 'pouvait'.",
  },
  {
    id: 11,
    phrase: "Tu ___ rester si tu veux.",
    reponse: "peux",
    explication:
      "On peut remplacer par 'pouvais' → peux (verbe pouvoir, 2e personne).",
  },
  {
    id: 12,
    phrase: "Ça ___ arriver à tout le monde.",
    reponse: "peut",
    explication:
      "On peut remplacer par 'pouvait' → peut (verbe pouvoir, 3e personne).",
  },
...
const CHOIX = ["peu", "peux", "peut"];
const NB_QUESTIONS = 10;
type EtatQuestion = "attente" | "correct" | "incorrect";

export default function FichePeuPeuxPeut() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises Peu / Peux / Peut !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi de l'astuce 'pouvait'."
    ...
    >
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            <strong style={{ color: "#a78bfa" }}>PEU</strong> = pas beaucoup.
            Exemple : il mange <em>peu</em> = il ne mange pas beaucoup ✅<br />
            <strong style={{ color: "#ffd166" }}>PEUT</strong> = il / elle / on
            + action possible (pense à &quot;peut-être&quot; ou &quot;capable
            de&quot;). Exemple : il <em>peut</em> nager = il est capable de
            nager ✅<br />
            <strong style={{ color: "#2ec4b6" }}>PEUX</strong> = verbe pouvoir
            avec je ou tu. Exemple : je <em>peux</em> venir, tu <em>peux</em>{" "}
            partir ✅
          </p>
        </div>
