...
const TOUTES_LES_QUESTIONS = [
  {
    ...
    phrase: "23 × 11 = ?",
    reponse: "253",
    explication: "2 et 3 → 2+3=5 → 253 ✅",
  },
  {
    id: 2,
    phrase: "41 × 11 = ?",
    reponse: "451",
    explication: "4 et 1 → 4+1=5 → 451 ✅",
  },
  {
    id: 3,
    phrase: "35 × 11 = ?",
    reponse: "385",
    explication: "3 et 5 → 3+5=8 → 385 ✅",
  },
  {
    id: 4,
    phrase: "62 × 11 = ?",
    reponse: "682",
    explication: "6 et 2 → 6+2=8 → 682 ✅",
  },
  {
    id: 5,
    phrase: "14 × 11 = ?",
    reponse: "154",
    explication: "1 et 4 → 1+4=5 → 154 ✅",
  },
  {
    id: 6,
    phrase: "72 × 11 = ?",
    reponse: "792",
    explication: "7 et 2 → 7+2=9 → 792 ✅",
  },
  {
    id: 7,
    phrase: "53 × 11 = ?",
    reponse: "583",
    explication: "5 et 3 → 5+3=8 → 583 ✅",
  },
  {
    id: 8,
    phrase: "31 × 11 = ?",
    reponse: "341",
    explication: "3 et 1 → 3+1=4 → 341 ✅",
  },
  {
    id: 9,
    phrase: "24 × 11 = ?",
    reponse: "264",
    explication: "2 et 4 → 2+4=6 → 264 ✅",
  },
  {
    id: 10,
    phrase: "43 × 11 = ?",
    reponse: "473",
    explication: "4 et 3 → 4+3=7 → 473 ✅",
  },
  {
    id: 11,
    phrase: "61 × 11 = ?",
    reponse: "671",
    explication: "6 et 1 → 6+1=7 → 671 ✅",
  },
  {
    id: 12,
    phrase: "52 × 11 = ?",
    reponse: "572",
    explication: "5 et 2 → 5+2=7 → 572 ✅",
  },
];
...
const getChoix = (reponse: string): string[] => {
  ...
  return [String(n - 11), reponse, String(n + 11)].sort(
    () => Math.random() - 0.5,
  );
};
...
export default function FicheMultiplier11() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises ×11 !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi : écarte les chiffres et mets leur somme au milieu."
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.85rem" }}>
            L&apos;astuce des chiffres qui s&apos;additionnent
          </p>
        </div>
        ...
        >
          ...
          >
            💡 L&apos;astuce magique — exemple : 23 × 11
          </p>
          ...
          >
            ...
            >
              <span style={{ color: "#ffd166" }}>2</span>
              <span style={{ color: "#2ec4b6" }}>5</span>
          ...
          >
            <strong style={{ color: "#ff6b6b" }}>La règle :</strong> prends les
            2 chiffres du nombre, mets leur{" "}
            <strong style={{ color: "#2ec4b6" }}>somme entre eux</strong> !
            <br />
            <strong style={{ color: "rgba(255,255,255,0.4)" }}>
              Attention :
            </strong>{" "}
            si la somme dépasse 9, ajoute 1 au chiffre de gauche. Ex : 75×11 →
            7+(7+5=12)→ 8+2+5 = 825
          </p>
        </div>
