...
const TOUTES_LES_QUESTIONS = [
  {
    ...
    phrase: "12 × 25 = ?",
    reponse: "300",
    explication: "12 ÷ 4 = 3 → 3 × 100 = 300 ✅",
  },
  {
    id: 2,
    phrase: "8 × 25 = ?",
    reponse: "200",
    explication: "8 ÷ 4 = 2 → 2 × 100 = 200 ✅",
  },
  {
    id: 3,
    phrase: "20 × 25 = ?",
    reponse: "500",
    explication: "20 ÷ 4 = 5 → 5 × 100 = 500 ✅",
  },
  {
    id: 4,
    phrase: "16 × 25 = ?",
    reponse: "400",
    explication: "16 ÷ 4 = 4 → 4 × 100 = 400 ✅",
  },
  {
    id: 5,
    phrase: "24 × 25 = ?",
    reponse: "600",
    explication: "24 ÷ 4 = 6 → 6 × 100 = 600 ✅",
  },
  {
    id: 6,
    phrase: "36 × 25 = ?",
    reponse: "900",
    explication: "36 ÷ 4 = 9 → 9 × 100 = 900 ✅",
  },
  {
    id: 7,
    phrase: "4 × 25 = ?",
    reponse: "100",
    explication: "4 ÷ 4 = 1 → 1 × 100 = 100 ✅",
  },
  {
    id: 8,
    phrase: "28 × 25 = ?",
    reponse: "700",
    explication: "28 ÷ 4 = 7 → 7 × 100 = 700 ✅",
  },
  {
    id: 9,
    phrase: "40 × 25 = ?",
    reponse: "1 000",
    explication: "40 ÷ 4 = 10 → 10 × 100 = 1 000 ✅",
  },
  {
    id: 10,
    phrase: "32 × 25 = ?",
    reponse: "800",
    explication: "32 ÷ 4 = 8 → 8 × 100 = 800 ✅",
  },
  {
    id: 11,
    phrase: "44 × 25 = ?",
    reponse: "1 100",
    explication: "44 ÷ 4 = 11 → 11 × 100 = 1 100 ✅",
  },
  {
    id: 12,
    phrase: "48 × 25 = ?",
    reponse: "1 200",
    explication: "48 ÷ 4 = 12 → 12 × 100 = 1 200 ✅",
  },
];
...
const getChoix = (reponse: string): string[] => {
  const n = parseInt(reponse.replace(/\s/g, ""));
  return [String(n - 100), reponse, String(n + 100)].sort(
    () => Math.random() - 0.5,
  );
};
...
export default function FicheMultiplier25() {
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "8px" }}>
            {pourcentage >= 80
              ? "Bravo ! Tu maîtrises ×25 !"
              : pourcentage >= 50
                ? "Pas mal ! Rappelle-toi : ÷4 puis ×100."
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.85rem" }}>
            ÷4 puis ×100 — aussi simple que ça !
          </p>
        </div>
        ...
        >
          ...
          >
            💡 L&apos;astuce magique — exemple : 12 × 25
          </p>
          ...
          >
            <strong style={{ color: "#ffd166" }}>Étape 1 :</strong> divise par{" "}
            <strong style={{ color: "#ffd166" }}>4</strong>
            <br />
            <strong style={{ color: "#2ec4b6" }}>Étape 2 :</strong> multiplie
            par <strong style={{ color: "#2ec4b6" }}>100</strong> (ajoute deux
            zéros)
            <br />
            <strong style={{ color: "rgba(255,255,255,0.4)" }}>
              Pourquoi ?
            </strong>{" "}
            25 = 100÷4, donc ×25 = ÷4 puis ×100
          </p>
        </div>
